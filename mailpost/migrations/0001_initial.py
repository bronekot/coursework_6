    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_token', models.CharField(blank=True, default=mailpost.models.generate_verification_token, max_length=100)),
        ...
        migrations.AddField(
            model_name='mailing',
            name='message',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mailpost.message'),
        ),
    ]
